...
const cors = require('cors'); // The Bouncer
...
// --- 🔓 THE FIX: ALLOW EVERYONE ---
app.use(cors({
    origin: '*', // Allow any computer/phone
...
const io = new Server(server, { 
    cors: { origin: "*" } // Allow Socket connections too
});
...
const Order = mongoose.model('Order', new mongoose.Schema({
    customerName: String, address: String, items: Array, totalAmount: Number, status: { type: String, default: "Pending" }, createdAt: { type: Date, default: Date.now }
}));
